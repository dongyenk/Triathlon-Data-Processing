...
* Once the user has input the hr-min-sec time values for a triathlon athelete, the program will output processed data about the athelete, in a nice format.
